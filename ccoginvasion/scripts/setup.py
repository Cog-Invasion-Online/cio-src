...
def run_cmake(config, args):
    ...
    try_execute("C:\\Program Files (x86)\\CMake\\bin\\cmake", join_abs(get_script_dir(), ".."), *cmake_args)
...
def run_cmake_build(config, args):
    ...
    try_execute("C:\\Program Files (x86)\\CMake\\bin\\cmake", "--build", ".", "--config", configuration, "--", core_option)
