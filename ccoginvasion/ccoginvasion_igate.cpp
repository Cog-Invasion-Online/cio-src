...
#include "pnotify.h"
#include <sstream>
#define PANDA_LIBRARY_NAME_ccoginvasion
#include "py_panda.h"
#include "extension.h"
#include "dcast.h"
...
/**
 * Forward declarations for top-level class SmartCamera
 */
typedef SmartCamera SmartCamera_localtype;
Define_Module_Class(ccoginvasion, SmartCamera, SmartCamera_localtype, SmartCamera);
static struct Dtool_PyTypedObject *const Dtool_Ptr_SmartCamera = &Dtool_SmartCamera;
static void Dtool_PyModuleClassInit_SmartCamera(PyObject *module);
...
/**
 * Python wrappers for functions of class SmartCamera
 */
/**
 * Python function wrapper for:
 * SmartCamera::SmartCamera(void)
 * inline SmartCamera::SmartCamera(SmartCamera const &) = default
 */
static int Dtool_Init_SmartCamera(PyObject *self, PyObject *args, PyObject *kwds) {
  if (kwds != nullptr && PyDict_Size(kwds) > 0) {
#ifdef NDEBUG
    Dtool_Raise_TypeError("function takes no keyword arguments");
    return -1;
#else
    Dtool_Raise_TypeError("SmartCamera() takes no keyword arguments");
    return -1;
#endif
  }
  int parameter_count = (int)PyTuple_Size(args);
  ...
  case 0:
    {
      // 1-SmartCamera::SmartCamera(void)
      SmartCamera *return_value = new SmartCamera();
      if (return_value == nullptr) {
        PyErr_NoMemory();
        return -1;
      }
      ...
      return DTool_PyInit_Finalize(self, (void *)return_value, &Dtool_SmartCamera, true, false);
    }
    break;
  case 1:
    {
      PyObject *arg = PyTuple_GET_ITEM(args, 0);
      // 1-inline SmartCamera::SmartCamera(SmartCamera const &) = default
      SmartCamera const *arg_this = (SmartCamera *)DTOOL_Call_GetPointerThisClass(arg, Dtool_Ptr_SmartCamera, 0, "SmartCamera.SmartCamera", true, true);
      if (arg_this != nullptr) {
        SmartCamera *return_value = new SmartCamera(*arg_this);
        if (return_value == nullptr) {
          PyErr_NoMemory();
          return -1;
        }
  ...
  default:
    PyErr_Format(PyExc_TypeError,
                 "SmartCamera() takes 0 or 1 arguments (%d given)",
                 parameter_count);
    return -1;
#endif
  }
  if (!_PyErr_OCCURRED()) {
    Dtool_Raise_BadArgumentsError(
      "SmartCamera()\n"
      "SmartCamera(const SmartCamera param0)\n");
  }
  return -1;
}

static void *Dtool_UpcastInterface_SmartCamera(PyObject *self, Dtool_PyTypedObject *requested_type) {
  Dtool_PyTypedObject *type = DtoolInstance_TYPE(self);
  if (type != &Dtool_SmartCamera) {
    printf("SmartCamera ** Bad Source Type-- Requesting Conversion from %s to %s\n", Py_TYPE(self)->tp_name, requested_type->_PyType.tp_name); fflush(nullptr);
    return nullptr;
  }

  SmartCamera *local_this = (SmartCamera *)DtoolInstance_VOID_PTR(self);
  if (requested_type == &Dtool_SmartCamera) {
    return local_this;
  }
  return nullptr;
}

static void *Dtool_DowncastInterface_SmartCamera(void *from_this, Dtool_PyTypedObject *from_type) {
  if (from_this == nullptr || from_type == nullptr) {
    return nullptr;
  }
  if (from_type == Dtool_Ptr_SmartCamera) {
    return from_this;
  }
  return nullptr;
}
 ...
 */
static PyObject *Dtool_SuitPathFinderAI_plan_path_54(PyObject *self, PyObject *args, PyObject *kwds) {
...
#ifndef NDEBUG
static const char *Dtool_SuitPathFinderAI_plan_path_54_comment =
  "C++ Interface:\n"
  "plan_path(const SuitPathFinderAI self, object from, object to, float close_enough)\n"
  "\n"
  "//                       tuple           tuple";
#else
static const char *Dtool_SuitPathFinderAI_plan_path_54_comment = nullptr;
#endif
 ...
 */
static PyObject *Dtool_SuitPathFinderAI_add_polygon_55(PyObject *self, PyObject *arg) {
  SuitPathFinderAI *local_this = nullptr;
...
#ifndef NDEBUG
static const char *Dtool_SuitPathFinderAI_add_polygon_55_comment =
  "C++ Interface:\n"
  "add_polygon(const SuitPathFinderAI self, object points)\n"
  "\n"
  "//      list";
#else
static const char *Dtool_SuitPathFinderAI_add_polygon_55_comment = nullptr;
#endif
 ...
 */
static PyObject *Dtool_SuitPathFinderAI_build_neighbors_56(PyObject *self, PyObject *) {
  SuitPathFinderAI *local_this = nullptr;
...
#ifndef NDEBUG
static const char *Dtool_SuitPathFinderAI_build_neighbors_56_comment =
  "C++ Interface:\n"
  "build_neighbors(const SuitPathFinderAI self)\n";
#else
static const char *Dtool_SuitPathFinderAI_build_neighbors_56_comment = nullptr;
#endif
...
/**
 * Python method tables for SmartCamera (SmartCamera)
 */
static PyMethodDef Dtool_Methods_SmartCamera[] = {
  {"__copy__", &copy_from_copy_constructor, METH_NOARGS, nullptr},
  {"__deepcopy__", &map_deepcopy_to_copy, METH_VARARGS, nullptr},
  {nullptr, nullptr, 0, nullptr}
};

static PyNumberMethods Dtool_NumberMethods_SmartCamera = {
  nullptr,
  nullptr,
  nullptr,
#if PY_MAJOR_VERSION < 3
...
struct Dtool_PyTypedObject Dtool_SmartCamera = {
  {
    PyVarObject_HEAD_INIT(nullptr, 0)
    "ccoginvasion.SmartCamera",
    sizeof(Dtool_PyInstDef),
    0, // tp_itemsize
    &Dtool_FreeInstance_SmartCamera,
    nullptr,
    nullptr,
    nullptr,
#if PY_VERSION_HEX >= 0x03050000
...
#endif
    nullptr,
    &Dtool_NumberMethods_SmartCamera,
    nullptr, // tp_as_sequence
    nullptr, // tp_as_mapping
    nullptr, // tp_hash
    nullptr,
    ...
    nullptr,
    0, // tp_dictoffset
    Dtool_Init_SmartCamera,
    PyType_GenericAlloc,
    Dtool_new_SmartCamera,
    PyObject_Del,
    nullptr, // tp_is_gc
    nullptr, // tp_bases
    nullptr, // tp_mro
  ...
  TypeHandle::none(),
  Dtool_PyModuleClassInit_SmartCamera,
  Dtool_UpcastInterface_SmartCamera,
  Dtool_DowncastInterface_SmartCamera,
  nullptr,
  nullptr,
};
...
static void Dtool_PyModuleClassInit_SmartCamera(PyObject *module) {
  ...
  if (!initdone) {
    initdone = true;
    // Dependent objects
    Dtool_SmartCamera._PyType.tp_base = (PyTypeObject *)Dtool_GetSuperBase();
    PyObject *dict = PyDict_New();
    Dtool_SmartCamera._PyType.tp_dict = dict;
    PyDict_SetItemString(dict, "DtoolClassDict", dict);
    if (PyType_Ready((PyTypeObject *)&Dtool_SmartCamera) < 0) {
      Dtool_Raise_TypeError("PyType_Ready(SmartCamera)");
      return;
    }
    Py_INCREF((PyTypeObject *)&Dtool_SmartCamera);
  }
}
...
static PyMethodDef Dtool_Methods_SuitPathFinderAI[] = {
  {"plan_path", (PyCFunction) &Dtool_SuitPathFinderAI_plan_path_54, METH_VARARGS | METH_KEYWORDS, (const char *)Dtool_SuitPathFinderAI_plan_path_54_comment},
  {"planPath", (PyCFunction) &Dtool_SuitPathFinderAI_plan_path_54, METH_VARARGS | METH_KEYWORDS, (const char *)Dtool_SuitPathFinderAI_plan_path_54_comment},
  {"add_polygon", &Dtool_SuitPathFinderAI_add_polygon_55, METH_O, (const char *)Dtool_SuitPathFinderAI_add_polygon_55_comment},
  {"addPolygon", &Dtool_SuitPathFinderAI_add_polygon_55, METH_O, (const char *)Dtool_SuitPathFinderAI_add_polygon_55_comment},
  {"build_neighbors", &Dtool_SuitPathFinderAI_build_neighbors_56, METH_NOARGS, (const char *)Dtool_SuitPathFinderAI_build_neighbors_56_comment},
  {"buildNeighbors", &Dtool_SuitPathFinderAI_build_neighbors_56, METH_NOARGS, (const char *)Dtool_SuitPathFinderAI_build_neighbors_56_comment},
  {"__copy__", &copy_from_copy_constructor, METH_NOARGS, nullptr},
  {"__deepcopy__", &map_deepcopy_to_copy, METH_VARARGS, nullptr},
  {nullptr, nullptr, 0, nullptr}
};
...
void Dtool_ccoginvasion_BuildInstants(PyObject *module) {
  ...
  // SmartCamera
  Dtool_PyModuleClassInit_SmartCamera(module);
  PyModule_AddObject(module, "SmartCamera", (PyObject *)&Dtool_SmartCamera);
  // SuitPathFinderAI
