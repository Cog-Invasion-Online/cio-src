...
static void Dtool_PyModuleClassInit_AudioClip(PyObject *module) {
  ...
  if (!initdone) {
    initdone = true;
    // Dependent objects
    Dtool_AudioClip._PyType.tp_base = (PyTypeObject *)&Dtool_DTOOL_SUPER_BASE;
...
static void Dtool_PyModuleClassInit_CNametag(PyObject *module) {
  ...
  if (!initdone) {
    initdone = true;
    // Dependent objects
    Dtool_CNametag._PyType.tp_base = (PyTypeObject *)&Dtool_DTOOL_SUPER_BASE;
    PyObject *dict = PyDict_New();
...
static void Dtool_PyModuleClassInit_CTMusicData(PyObject *module) {
  ...
  if (!initdone) {
    initdone = true;
    // Dependent objects
    Dtool_CTMusicData._PyType.tp_base = (PyTypeObject *)&Dtool_DTOOL_SUPER_BASE;
    PyObject *dict = PyDict_New();
...
static void Dtool_PyModuleClassInit_CTMusicManager(PyObject *module) {
  ...
  if (!initdone) {
    initdone = true;
    // Dependent objects
    Dtool_CTMusicManager._PyType.tp_base = (PyTypeObject *)&Dtool_DTOOL_SUPER_BASE;
    PyObject *dict = PyDict_New();
...
static void Dtool_PyModuleClassInit_Lerper(PyObject *module) {
  ...
  if (!initdone) {
    initdone = true;
    // Dependent objects
    Dtool_Lerper._PyType.tp_base = (PyTypeObject *)&Dtool_DTOOL_SUPER_BASE;
    PyObject *dict = PyDict_New();
...
static void Dtool_PyModuleClassInit_SuitPathFinderAI(PyObject *module) {
  ...
  if (!initdone) {
    initdone = true;
    // Dependent objects
    Dtool_SuitPathFinderAI._PyType.tp_base = (PyTypeObject *)&Dtool_DTOOL_SUPER_BASE;
    PyObject *dict = PyDict_New();
...
#ifndef LINK_ALL_STATIC
  RegisterNamedClass("AudioClip", Dtool_AudioClip);
#endif
#ifndef LINK_ALL_STATIC
  RegisterNamedClass("CNametag", Dtool_CNametag);
#endif
#ifndef LINK_ALL_STATIC
  RegisterNamedClass("CNametag3d", Dtool_CNametag3d);
#endif
#ifndef LINK_ALL_STATIC
  RegisterNamedClass("CTMusicData", Dtool_CTMusicData);
#endif
#ifndef LINK_ALL_STATIC
  RegisterNamedClass("CTMusicManager", Dtool_CTMusicManager);
#endif
#ifndef LINK_ALL_STATIC
  RegisterNamedClass("Lerper", Dtool_Lerper);
#endif
#ifndef LINK_ALL_STATIC
  RegisterNamedClass("SuitPathFinderAI", Dtool_SuitPathFinderAI);
#endif
}

void Dtool_ccoginvasion_ResolveExternals() {
#ifndef LINK_ALL_STATIC
