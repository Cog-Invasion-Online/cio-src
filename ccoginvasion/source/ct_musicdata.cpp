...
PT( GenericAsyncTask ) CTMusicData::am_update_task = nullptr;
...
void CTMusicData::initialize_chunk_data()
{
        ...
        PT( GenericAsyncTask ) updatetask = new GenericAsyncTask( "CTMusicData::update_audioManager", &CTMusicData::audiomgr_update_task, nullptr );
