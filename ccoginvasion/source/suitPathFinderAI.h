 ...
 *
 * @file suitPathFinderAI.h
 * @author Brian Lach
 * @date 2017-03-03
 */

#ifndef __SUITPATHFINDERAI_H__
#define __SUITPATHFINDERAI_H__
...
PUBLISHED:
              //      list
  SuitPathFinderAI(PyObject *polygons = (PyObject *)NULL);
