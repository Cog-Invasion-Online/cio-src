 ...
 *
 * @file ct_musicmgr.cpp
 * @author Brian Lach
 * @date 2016-06-28
 */

#include "ct_musicmgr.h"
#include "tools.cpp"
...
{
        PT( GenericAsyncTask ) task = new GenericAsyncTask( "LTM", &CTMusicManager::load_tournament_music, nullptr );
