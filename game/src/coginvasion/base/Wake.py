...
class Wake(NodePath):
    ...
    def __init__(self, parent = hidden, target = hidden):
        ...
        self.target = target
        self.ripples = loader.loadModel("phase_4/models/props/ripples.bam")
        ...
        self.sortBase = 10
        self.rippleCount = 0
        self.doLaters = [None] * 500
        self.trackId = Wake.wakeCount
        Wake.wakeCount += 1
        return

    def createRipple(self, zPos, rate = 1.0, startFrame = 0, rippleScale = (1.0, 1.0, 1.0)):
        ...
        self.rippleCount = (self.rippleCount + 1) % 500
...
class WakeSequence(NodePath):
    ...
    def __init__(self, parent = hidden):
        NodePath.__init__(self)
        self.assign(loader.loadModel("phase_4/models/props/wake.bam"))
