...
class FilterManager(DirectObject):
    ...
    def renderSceneInto(self, depthtex=None, colortex=None, auxtex=None, auxbits=0, textures=None):
        ...
        * All clears are disabled on the original display region.
        ...
        buffer = self.createBuffer("filter-base", winx, winy, texgroup, scene=True)
    ...
    def renderQuadInto(self, name="filter-stage", mul=1, div=1, align=1, depthtex=None, colortex=None, auxtex0=None, auxtex1=None, size = None, addToList = True, fullscreen = True):
    ...
    def createBuffer(self, name, xsize, ysize, texgroup, depthbits=1, scene=False):
