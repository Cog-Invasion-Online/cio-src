...
numFloors2roomsVisited = {
    1: [CUBICLE_FLOOR],
    2: [CUBICLE_FLOOR, EXECUTIVE_FLOOR],
    3: [CUBICLE_FLOOR, CUBICLE_FLOOR, EXECUTIVE_FLOOR],
    4: [CUBICLE_FLOOR, CUBICLE_FLOOR, CUBICLE_FLOOR, EXECUTIVE_FLOOR],
    5: [CUBICLE_FLOOR, CUBICLE_FLOOR, CUBICLE_FLOOR, CUBICLE_FLOOR, EXECUTIVE_FLOOR]
}
