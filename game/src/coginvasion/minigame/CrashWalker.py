"""
CrashWalker.py is for the crash bandicoot-style minigame.
...
class Direction:
    ...
    @staticmethod
    def getHeading(direction, otherdir):
        if (direction == Direction.Forward):
            if (otherdir == Direction.Null):
                return base.minigame.camNode.getH(render)
            elif (otherdir == Direction.Left):
                return base.minigame.camNode.getH(render) + 45
            elif (otherdir == Direction.Right):
                return base.minigame.camNode.getH(render) + 315

        elif (direction == Direction.Reverse):
            if (otherdir == Direction.Null):
                return base.minigame.camNode.getH(render) + 180
            elif (otherdir == Direction.Left):
                return base.minigame.camNode.getH(render) + 135
            elif (otherdir == Direction.Right):
                return base.minigame.camNode.getH(render) + 225

        elif (direction == Direction.Left):
            if (otherdir == Direction.Null):
                return base.minigame.camNode.getH(render) + 90
            elif (otherdir == Direction.Forward):
                return base.minigame.camNode.getH(render) + 45
            elif (otherdir == Direction.Reverse):
                return base.minigame.camNode.getH(render) + 135

        elif (direction == Direction.Right):
            if (otherdir == Direction.Null):
                return base.minigame.camNode.getH(render) + 270
            elif (otherdir == Direction.Forward):
                return base.minigame.camNode.getH(render) + 315
            elif (otherdir == Direction.Reverse):
                return base.minigame.camNode.getH(render) + 225
