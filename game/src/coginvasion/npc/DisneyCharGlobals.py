...
CHATTER = {
    # Shared stuff
    SHARED_GREETINGS: ['Hi, {avatarName}!',
        'Yoo-hoo {avatarName}, nice to see you.',
        "I'm glad you're here today!",
        'Well, hello there, {avatarName}.'],
    SHARED_COMMENTS: ["That's a great name, {avatarName}.",
        'I like your name.',
    ...
    WINTER_GREETINGS: ['Happy winter holidays, {avatarName}!',
        "Ho, ho, ho!",
        "Merry Christmas, {avatarName}!",
        "Happy holidays, {avatarName}!"],
    WINTER_COMMENTS: ["I just love this weather!",
        "Don't you just love this weather, {avatarName}?",
        "Brrrrrgh!"],
    ...
    CHAR_GREETINGS: {
        ...
        DAISY: ['Welcome to my garden!', "Hello, I'm Daisy. What's your name?", "It's so nice to see you {avatarName}!"],
    ...
    CHAR_COMMENTS: {
        ...
        MINNIE: ['The hills are alive with the sound of music!',
              'You have a cool outfit, {avatarName}.',
              ...
              'Hey {avatarName}, look at that over there.',
...
GoofySpeedwayChatter = (['Welcome to ' + ZoneUtil.ToontownCentral + '.', 'Hi, my name is ' + Goofy + ". What's yours?", "Gawrsh, it's nice to see you {avatarName}!", 'Boy, I saw a terrific race earlier.',
